Ext.define('CRP.view.News', {
	...
	config: {
		...
		items: [{
			...
			itemTpl: [
				'<div style="position:absolute;top:28px;left:11px">',
					'<div class="avatar-img">',
						'<img class="listImgDef" src="{Image}" />',
					'</div>',
				'</div>',
				'<div class="avatar-row defaultFont-style" style="margin-left:65px;">',
					'<div class="head text-overflow">',
						'<span class="proName">{FeedTitle}</span>',
					'</div>',
					'<div class="rowscontent">{FeedCont}</div>',
					'<div class="expand">',
						'<img class="email" src="resources/images/email.png" />',
						'<span class="split">|</span>',
						'<img class="share" src="resources/images/share.png" />',
						'<span class="split">|</span>',
						'<tpl if="Collect==\'1\'">',
							'<img class="collected" src="resources/images/collected.png" />',
						'<tpl else>',
							'<img class="notCollect" src="resources/images/notCollect.png" />',
						'</tpl>',
					'</div>',
				'</div>',
				'<div>',
